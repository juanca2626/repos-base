            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width"
                ...
                <tr>
                    <td style="" align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                        mc:edit="module_body">
                        <img src="https://res.cloudinary.com/litodti/image/upload/v1744302639/aurora/iconos/icon-confirmation.png" alt="#" width="100%" style="margin: 12px; max-width:10%; display:block; width:10%; height:auto; padding-top: 0rem;border-radius: .5rem;"
                        ...
                        <p style="font-weight: 500; text-align: center; margin-top: 0.5rem; color: #3D3D3D; font-size: 16px;letter-spacing: 1.5%">
                    ...
                    <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                        ...
                        <div style="margin-bottom: 0rem; padding: 0 1rem;">
                            <p style="font-weight: 500; text-align: left; margin-bottom: 1rem; color: #3D3D3D;">
                                Su ejecutivo(a) <strong>{{ $reservation['executive_name'] }}</strong>  acaba de realizar una reserva.
                            </p>
                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                        ...
                        <div style="background-color: #FAFAFA; border-radius: 6px;padding: 20px 20px; margin-bottom: 20px">
                                ...
                                @endif
                                        ...
                                        <div style="display: flex; align-items: center; margin-bottom: 0.3rem;">
                                            <img src="https://res.cloudinary.com/litodti/image/upload/v1744302640/aurora/iconos/icon-dolar.png" alt="#"
                                                ...
                                                mc:label="header_image" mc:edit="module_image" mc:allowdesigner
                                                mc:allowtext />
                                                <p style="font-weight: 600; font-size: 14px; text-align: left; color: #EB5757; margin:0;">Total tarifa:
                                        ...
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #3D3D3D; ">
                                            <strong style="color: #3D3D3D; font-size: 14px;">Código Confirmación Channel: </strong> {{ $resHotRoom['channel_reservation_code_master'] }}
                                        </p>
                            ...
                            {{-- <p style="font-weight: 500; text-align: left; margin-top: 3rem; margin-bottom: 0.5rem; margin-left: 22px; color: #2E2E2E; ">
