            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width"
                ...
                <tr>
                    <td style="" align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                        mc:edit="module_body">              
                        <img src="https://backend.limatours.com.pe/images/pencil.png" alt="#" width="100%" style="margin: 12px; max-width:10%; display:block; width:10%; height:auto; padding-top: 0rem;border-radius: .5rem;"
    ...
    <tr mc:repeatable="module" mc:variant="module_text_row" mc:hideable>
        <td align="center" valign="top">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width" style="margin-bottom: 20px">
                <tr>
                    <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"  mc:edit="module_body" style="padding-bottom: 2rem;background-color: #f5e4e4!important;">                      
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width">
                <tr>
                    <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"  mc:edit="module_body" style="padding-bottom: 2rem;background-color: #baf1c7!important;">

                      
                        <h3 style="padding: 0 1rem;color: black; font-size: 1rem; font-weight: 600; letter-spacing: 1px;text-align: left; margin-bottom: 0;">Reserva Modificada</h3>
                        <hr />  
                        @if( isset($notas))
                            <div>
                                <div style="display: flex; padding:  1rem 1rem 0.3rem 1rem;">
