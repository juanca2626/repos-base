                    ...
                    <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                        ...
                        <div style="margin-bottom: 0rem; padding: 0 1rem;">
                            <p style="font-weight: 500; text-align: left; margin-bottom: 1rem; color: #2E2E2E;">
                                El ejecutivo(a) <strong>{{ $file['executive_name'] }}</strong>  solicita una modificación a su reserva.                              
                            </p>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width">
                <tr>
                    <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                        ...
                        <h3 style="color: #EB5757; font-size: 1.5rem; font-weight: 600; letter-spacing: 1px;text-align: left; margin-bottom: 20px;">Detalles de la reserva</h3>
                        ...
                        <div style="background-color: #FFF2F2; padding-top: 20px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px;margin-bottom: 27px;">
                            <h5 style="padding: 0 1rem ; font-size: 1.0rem; font-weight: 600; letter-spacing: 1px;text-align: left; margin: 0;">Reserva anterior</h3>
                            ...
                            <div>
                                <div style="display: flex; padding:  1rem 1rem 0rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 600; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <strong style=" float: right; margin-right: 81px; font-weight: 500; color:black">Adultos <span style="margin-left: 12px;">{{  $file['adults'] }}</span></strong>                                     
                                    </p>
                                </div>
                                ...
                                <div style="overflow: hidden; padding: 0 0.8rem;margin-bottom: 14px;">
                                    ...
                                    <div style="float:left; display: block; margin-left: 10px; margin-right: 10px; width: 100%;">
                                        ...
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 1.5rem; color: #2E2E2E; ">
                                            ...
                                            <span style="color: #2E2E2E;  float: right; margin-right: 63px;">Niños: <span style="margin-left: 25px;">{{  $file['children'] }}</span>  </span> 
                                        </p>
                                        <div style="clear: both;"></div>
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E; ">
                                            <span style="color: #2E2E2E; "></span> 
                                            <span style="color: #2E2E2E;  float: right; margin-right: 61px;">Infantes: <span style="margin-left: 6px;">{{  $file['infants'] }}</span>  </span> 
                                        </p>   
                                        <div style="clear: both;"></div>                                 
                                    </div>                        
                                </div>    
                            ...
                            <div style="    margin-bottom: 35px;">
                                <div style="display: flex; padding:  1rem 1rem 0.3rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 600; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <strong >Nombre de los servicios</strong> 
                                        <strong style=" float: right; margin-right: 70px; color: #E4B804;">$ Penalidad</strong>                                     
                                    </p>
                                </div>
                                ...
                                <div style="overflow: hidden; padding: 0 0.8rem;">
                                    ...
                                    <div style="float:left; display: block; margin-left: 10px; margin-right: 10px; width: 100%;">
                                        ...
                                        @foreach($services['cancellation']['components'] as $component)                                
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E; ">
                                            ...
                                            <span style="color: #2E2E2E;  float: right; margin-right: 76px;">USD  {{ number_format($component['penality'], 2, '.', '') }}  </span> 
                                        </p>
                                        @endforeach                                   
                                    </div>                        
                                </div>
                            ...
                            <div style="    margin-bottom: 35px;">
                                <div style="display: flex; padding:  0.5rem 1rem 0.3rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 500; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <strong style=" float: right; margin-right: 93px;color: #E4B804;">USD  {{ number_format($services['cancellation']['total_penality'], 2, '.', '') }} </strong>                                     
                                    </p>
                                </div>
                        ...
                        <!----------------------------- Reserva modificada ---------------------------------------->
                        <div style="background-color: #DFFFE9; padding-top: 20px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">

                            <h5 style="padding: 0 1rem; font-size: 1.0rem; font-weight: 600; letter-spacing: 1px;text-align: left; margin: 0;">Reserva modificada</h3>
                            ...
                            <div style=" margin-bottom: 35px;">
                                <div style="display: flex; padding:  1rem 1rem 0.3rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 600; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <strong style=" float: right; margin-right: 100px;">$ Tarifas</strong>                                     
                                    </p>
                                </div>
                                ...
                                <div style="overflow: hidden; padding: 0 0.8rem;">
                                    ...
                                    <div style="float:left; display: block; margin-left: 10px; margin-right: 10px; width: 100%;">
                                        ...
                                        @foreach($services['reservations']['components'] as $component)                                
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E; ">
                                            <span style="color: #2E2E2E; ">{{ \Carbon\Carbon::parse($component['date_in'])->format('d/m/Y') }} </span> -
                                            <span style="color: #2E2E2E; ">{{ $component['name'] }}  </span> 
                                            <span style="color: #2E2E2E;  float: right; margin-right: 69px;">USD  {{ number_format($component['amount_cost'], 2, '.', '') }}  </span> 
                                        </p>
                                        @endforeach                                   
                                    </div>                        
                                </div>
                            ...
                            <div style="    margin-bottom: 35px;">
                                <div style="display: flex; padding:  0.5rem 1rem 0.3rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 500; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <span style="color: black;margin-left: 7px;" >Total tarifa</span> 
                                        <strong style=" float: right; margin-right: 83px;">USD  {{ number_format($services['reservations']['total_amount_cost'], 2, '.', '') }} </strong>                                     
                                    </p>
                                </div>
                                ...
                                <div style="display: flex; padding:  0.5rem 1rem 0.3rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 500; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <span style="color: black;margin-left: 7px;" >Penalidad</span> 
                                        <strong style=" float: right; margin-right: 91px; color: #979797;">USD  {{ number_format($services['cancellation']['total_penality'], 2, '.', '') }} </strong>                                     
                                    </p>
                                </div>
                                ...
                                <div style="display: flex; padding:  0.5rem 1rem 0.3rem 1rem;width: 100%;">
                                    ...
                                    <p style="font-weight: 500; text-align: left; color: #EB5757; margin:0; width: 100%;">
                                        ...
                                        <span style="color: black;margin-left: 7px;" >Monto Total</span> 
                                        <strong style=" float: right; margin-right: 83px; color: #3D3D3D;">USD  {{ number_format(($services['reservations']['total_amount_cost'] + $services['cancellation']['total_penality']), 2, '.', '') }} </strong>                                     
                                    </p>
                                </div>
                            ...
                            <div style="margin-bottom: 35px;">
                                ...
                                <div style="overflow: hidden; padding: 0 0.8rem;">
                                    ...
                                    <div style="float:left; display: block; margin-left: 10px; margin-right: 10px; width: 100%;">                                                                                                                                                                           
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E; ">
                                            <span style="color: #2E2E2E; float: left; height: 50px;padding-top: 10px;">Status de la reserva:</span> 
                                            <span style="color: #2E2E2E;  float: left; margin-left: 20px;">
                                                
                                                <span style="float: left; display: flex; background: #06C270; border-radius: .5rem;width: max-content;padding: 0.5rem;color: white;font-weight: 600;font-size: 14px; margin-left: 5px">
                                ...
                                @foreach($services['cancellation']['components'] as $index => $component)
                                <div style="overflow: hidden; padding: 0 0.8rem;">
                                    <div style="float:left; display: block; margin-left: 10px; margin-right: 10px; width: 100%;">                                                                                                                                                                           
                                        @if($index == 0)
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E; ">
