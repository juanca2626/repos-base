...
<body>
    <div class="container">
        ...
        <section class="invoice-info">
            <h3 style="text-align:center">NOTA DE DÉBITO</h3>
            <table style="margin-top: 20px">
                <tr>
        ...
        <table class="services" style="margin-top: 20px">
            ...
            @if ($debit_notes)
                <tbody>
                    @foreach ($debit_notes['details'] as $key => $detail)
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="background-color: #e9e9e9; text-align: center;">{{ $debit_notes['total'] }}</td>
                    </tr>
                </tfoot>
            @endif
        </table>
