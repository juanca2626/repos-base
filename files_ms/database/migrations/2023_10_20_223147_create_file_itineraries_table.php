...
return new class extends Migration {
    ...
    {
        Schema::create('file_itineraries', function (Blueprint $table) {
            $table->id();
            $table->foreignId('file_id')->constrained('files');
            $table->enum('entity', ['hotel', 'service', 'flight'])->comment('service/hotel/flight');
            $table->unsignedBigInteger('object_id')->comment('id service/hotel/flight');
            $table->text('name')->comment('Nombre del service/hotel/flight');
    ...
    {
        Schema::dropIfExists('file_itineraries');
    }
};
