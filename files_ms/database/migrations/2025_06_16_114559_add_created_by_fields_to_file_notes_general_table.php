...
return new class extends Migration
{
    ...
    {
        Schema::table('file_notes_general', function (Blueprint $table) {
            $table->unsignedBigInteger('created_by')->nullable()->after('classification_name')->comment('ID del usuario creador');
