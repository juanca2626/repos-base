...
namespace Src\Modules\File\Presentation\Http\Requests\FileNoteItinerary;

use Illuminate\Contracts\Validation\ValidationRule;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Http\Request;

class UpdateFileNoteItineraryRequest extends FormRequest
{
    /**
    ...
    public function rules(Request $request): array
    {
        return [
            ...
            'record_type' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if ($this->type_note !== 'INFORMATIVE' && $value !== 'FOR_DATE') {
                        $fail('El campo record_type solo puede ser '.$value.' cuando type_note es INFORMATIVE.');
                    }
                },
            ],
            ...
            'classification_code' => [
                'nullable',
                'required_if:record_type,FOR_DATE',
                'required_if:record_type,FOR_FILE',
                'required_if:type_note,REQUIREMENT',
            ],
            'classification_name' => [
                'nullable',
    ...
    public function messages()
    {
        return [
            ...
            'dates.required_if'                     => 'El campo dates es obligatorio.',
