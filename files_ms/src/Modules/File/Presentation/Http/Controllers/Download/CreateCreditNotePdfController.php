...
class CreateCreditNotePdfController extends Controller
{
    use ApiResponse;
    ...
    public function __invoke(Request $request, $file_id)
    {
        ...
        return Pdf::loadView('pdfs.credit-note', compact('statemet', 'client_aurora', 'limatours', 'file', 'trad', 'credit_notes'))->setPaper('a4', 'portrait')->setWarnings(false)->download('statement.pdf');
