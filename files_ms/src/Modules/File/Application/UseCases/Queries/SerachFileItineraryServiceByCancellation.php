...
class SerachFileItineraryServiceByCancellation implements QueryInterface
{
    ...
    public function handle(): array
    {
        return $this->fileItineraryRepository
            ->serachFileItineraryByCancellation(
                (new FileItineraryServiceByCancellation($this->file, $this->fileItineraryId , $this->params)
            )->jsonSerialize());
    }
}
