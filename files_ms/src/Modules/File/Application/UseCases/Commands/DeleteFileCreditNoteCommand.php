...
class DeleteFileCreditNoteCommand implements CommandInterface
{
    private FileCreditNoteRepositoryInterface $repository;

    public function __construct(private readonly int $file, private readonly int $credit_note_id )
    {
    ...
    {
        return $this->repository->delete($this->file, $this->credit_note_id);
    }
}
