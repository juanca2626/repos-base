...
trait Mailing
{
    ...
    public function initialize_mailing($base_url, $api_key, $timeout = '')
    {
        if (!function_exists('curl_init')) {
            throw new RuntimeException('Mailing requires cURL module');
        }
    ...
    */
    ...
    {
        return $this->deleteResource("account/" . $data['auth_key'], "");
    }
    ...
    */
    ...
    public function deleteResource($resource, $input)
    {
    ...
    */
    ...
    {
        return $this->deleteResource("campaign/" . $data['id'], "");
    }
    ...
    */
    ...
    {
        return $this->deleteResource("folder/" . $data['id'], "");
    }
    ...
    */
    ...
    {
        return $this->deleteResource("list/" . $data['id'], "");
    }
    ...
    */
    public function delete_users_list($data)
    {
        $id = $data['id'];
        unset($data['id']);
        return $this->deleteResource("list/" . $id . "/delusers", json_encode($data));
    }
    ...
    */
    ...
    {
        return $this->deleteResource("user/" . $data['email'], "");
    }
    ...
    */
    ...
    {
        return $this->deleteResource("webhook/" . $data['id'], "");
    }
    ...
    */
    ...
    {
        return $this->deleteResource("advanced/" . $data['id'], "");
    }
