...
trait QuoteDetailsPricePassengers
{
    ...
    private function getQuotePricePassenger($quote_id, $client_id, $lang)
    {
        ...
        foreach ($categories as $category) {
            $results = $this->geneateExportPassenger($quote_id,$editing_quote,$category["id"],$client_id,$lang);            
            array_push($sheets, [
        ...
        if($service["type"]=="hotel"){
            ...
            if($total_accommodations>0){
                ...
                $item = [
                    ...
                    "meal" => $service["service_rooms"][0]["rate_plan_room"]["rate_plan"]["meal"]["translations"][0]["value"],
                    "order" => 2,
                    "columns" => []
                ];
