...
{
    use Exportable, QuotesExportPassenger;
    ...
    {
        $result = $this->geneateExportPassenger($this->quote_id,$this->quote_original_id,$this->quote_category_id,$this->client_id,$this->lang);
        return
            view($result['view'], [
