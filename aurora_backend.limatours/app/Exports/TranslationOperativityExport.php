...
class TranslationOperativityExport implements FromView, WithEvents, WithTitle
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        $translations_inclusion = Translation::where('type', 'servicetypeactivity')->whereIn('language_id',
            $enabled_languages)->orderBy('language_id')->orderBy('object_id')->get()->groupBy('object_id');
