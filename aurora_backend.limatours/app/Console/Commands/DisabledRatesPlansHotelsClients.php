...
class DisabledRatesPlansHotelsClients extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'aurora:disabled_rates_hotels_all_clients';
        ...
        DB::transaction(function () use ($clients) {
            ...
            foreach ($clients as $client) {
                ...
                foreach ($rate_plans as $rate_plan) {
                    ...
                    $id_clients = $id_clients->where('id', $client->id)->get();
                    ...
                    if ($id_clients->count() === 0) {
                        ...
                        $query_deletes = ClientRatePlan::where('client_id', $client->id)
