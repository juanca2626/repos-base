...
class CallDisabledRatesPlansHotelsByClient extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'client:call_disabled_rates_hotels_client';
    ...
    public function handle()
    {
        ...
        foreach($clients as $client){
            $this->call('aurora:disabled_rates_hotels_client', ['client_id' => $client->id]);
            $progressbar->advance();
        }
