...
class UpdateRoomItem extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'update:room_item';
    ...
    public function handle()
    {
        ...
        foreach ($rooms as $room) {
            ...
            if($room->allows_child == "1" or $room->allows_teenagers == "1"){
                $sql .= "update rooms set min_adults={$room->min_adults}, max_child={$room->max_child} where id={$room->id};\n";
            }else{
        ...
        file_put_contents("room.txt", $sql);
