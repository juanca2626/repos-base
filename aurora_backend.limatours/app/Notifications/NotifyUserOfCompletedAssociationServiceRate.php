 ...
 */
class NotifyUserOfCompletedAssociationServiceRate extends Mailable
{
    ...
    {
        return $this->markdown('emails.service.notification_association_rate')
            ->subject('🔔 Servicio - Bloqueo de tarifa completado')
