                ...
                <tr>
                    ...
                    @if( isset($reservation['comment']) && $reservation['comment'] !== '' )
                        <div>
                            ...
                            <p style="padding: 0rem 0 0 1.5rem; margin: 0; font-size: 14.5px; list-style: none; ">
                        ...
                        <div>
                            <div style="display: flex; padding: 1rem;">
                                <img src="https://backend.limatours.com.pe/images/calendar.png"
                                     ...
                                     mc:label="header_image" mc:edit="module_image" mc:allowdesigner
                                     mc:allowtext/>
                                <p style="font-weight: 600; text-align: left; color: #EB5757; margin:0;">Fechas:</p>
                            </div>
                        </div>

                        <div style="overflow: hidden; padding: 0 0.8rem;">
                            @foreach($reservation['hotels'] as $h => $hotelReservation)
                                <div style="float:left; display: block; width: 246px; margin-bottom: 20px; margin-left: 10px; margin-right: 10px;">
                                    <p style="font-weight: 700; color: #2E2E2E; margin-top: 0;">{{ ordinalNumber($h) }} ingreso</p>
                                    <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 12px;margin-right: 10px;">Check in:</strong> <span style="padding-right: 0.5rem"> {{ convertDateTime($hotelReservation['check_in'], false) }}</span> <span style="">{{ substr($hotelReservation['check_in_time'], 0, 5) }}</span></p>
                                    <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 12px;">Check out:</strong> <span style="padding-right: 0.5rem"> {{ convertDateTime($hotelReservation['check_out'], false) }}</span> <span style="">{{ substr($hotelReservation['check_out_time'], 0, 5) }}</span></p>
                                    <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 12px;">Cantidad de noches:</strong> {{ $hotelReservation['nights'] }}</p>
                                </div>
                            @endforeach
                        </div>
...
{{--                                <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Cantidad de habitaciones: </strong> 01 </p>--}}
{{--                                <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Tipo de habitación:</strong> STANDARD DBL</p>--}}
{{--                                <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Ocupantes:</strong> 1</p>--}}
{{--                            </div>--}}
                            <div style="padding: 0rem 0 0 1.5rem;">
                                <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Cantidad de habitaciones: </strong> {{ count($hotelReservation['reservations_hotel_rooms']) }} </p>
                            </div>
                            <div style="overflow: hidden; padding: 0 0.8rem;">
                                @foreach($reservation['hotels'] as $h => $hotelReservation)
                                    @foreach($hotelReservation['reservations_hotel_rooms'] as $resHotRoom)
                                        ...
                                        @if( isset($resHotRoom['status']) and $resHotRoom['status'] !== 0 )
                                            <div style="float:left; display: block; margin-bottom: 20px; margin-left: 10px; margin-right: 10px;">
                                                <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Tipo de habitación:</strong> {{ $resHotRoom['room_name'] }}</p>
                                                <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Ocupantes:</strong> Adultos {{ $resHotRoom['adult_num'] }} | Niños {{ $resHotRoom['child_num'] }} |
                                                    Extras {{ $resHotRoom['extra_num'] }}</p>
                                                ...
                                                @if($resHotRoom['channel_code'] != 'AURORA')
                                                    ...
                                                    <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #2E2E2E; font-size: 13px;">Status Channel:</strong>
                                                        @switch($resHotRoom['status_in_channel'])
                                                            ...
                                                            @default
                                                            <b>Confirmado</b> {{ $resHotRoom['channel_reservation_code'] ? $resHotRoom['channel_reservation_code'] : '' }}
                                                        @endswitch
                                                    </p>
                        ...
                        <div>
                            <div style="display: flex; padding: 1rem;">
                                <img src="https://backend.limatours.com.pe/images/dollar.png"
                                     alt="#" width="24" height="18"
                                     style="display:block; padding-right: 0.2rem;"
                                     mc:label="header_image" mc:edit="module_image" mc:allowdesigner
                                     mc:allowtext/>
                                <p style="font-weight: 600; text-align: left; color: #EB5757; margin:0;">Tarifas:</p>
                            </div>
                            <div style="overflow: hidden; padding: 0 0.8rem;">
                                ...
                                @foreach($reservation['hotels'] as $h => $hotelReservation)
                                    @foreach($hotelReservation['reservations_hotel_rooms'] as $resHotRoom)
                                        ...
                                        @if( isset($resHotRoom['status']) and $resHotRoom['status'] !== 0 )
                                            <div style="float:left; display: block; margin-left: 10px; margin-right: 10px;">
                        ...
                        @if($reservation['mail_type'] != 'CANCELATION' && isset($reservation['confirmed']))
                            <div>
                                <div style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E; display: flex; align-items: center; margin-top: 1.5rem;">
                                    ...
                                    @else
                                        <!--  Cuando se solicita una reserva  -->
