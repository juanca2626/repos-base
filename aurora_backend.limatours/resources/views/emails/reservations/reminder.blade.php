                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width">
                            <tr>
                                <td width="100%" valign="top" bgcolor="#ffffff" align="center" style="">
                                    <img src="https://aurora.limatours.com.pe/images/logo.jpg" alt="#" width="30%"
                ...
                <tr mc:repeatable="module" mc:variant="module_text_row" mc:hideable>
                    <td align="center" valign="top">
                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width"
                            ...
                            <tr>
                                @if($reminder['reservation']['client']['language_id'] == 1)
                                    <td style="" align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                                        ...
                                        <p>
                                            Estimado cliente, <br>
                                            Le recordamos que el día {{ convertDate($reminder['date'], '-', '/', 1) }} vence el plazo para cancelar sin penalidad o reconfirmar la reserva {{ $reminder['reservation']['file_code'] }} - {{ $reminder['reservation']['customer_name'] }}.
                                        </p>
                                        <p>
                                            En cualquiera de los casos, por favor contacte a su especialista.
                                            <br> <br>
                                            LimaTours
                                        </p>
                                    </td>
                                @elseif($reminder['reservation']['client']['language_id'] == 3)
                                    <td style="" align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                                        mc:edit="module_body">
                                        <img src="https://backend.limatours.com.pe/images/alert.png" alt="#" width="100%" style="margin: 12px; max-width:10%; display:block; width:10%; height:auto; padding-top: 0rem;border-radius: .5rem;"
                                             mc:label="header_image" mc:edit="module_image" mc:allowdesigner mc:allowtext/>
                                        ...
                                        <p>
                                            Caro cliente, <br>
                                            Lembramos que o prazo para o cancelamento sem penalidade ou reconfirmação da reserva {{ $reminder['reservation']['file_code'] }} - {{ $reminder['reservation']['customer_name'] }} é até o dia {{ convertDate($reminder['date'], '-', '/', 1) }}.
                                        </p>
                                        <p>
                                            Em ambos os casos, favor entre em contato com seu especialista em vendas.
                                            <br> <br>
                                            LimaTours
                                        </p>
                                    </td>
                                @else
                                    <td style="" align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                                        ...
                                        <p>
                                            Dear Customer, <br>
                                            The penalty-free period expires in {{ convertDate($reminder['date'], '-', '/', 1) }} or reconfirm booking: {{ $reminder['reservation']['file_code'] }} - {{ $reminder['reservation']['customer_name'] }}.
                                        </p>
                                        <p>
                                            In any case, please contact your account executive.
                                            <br> <br>
                                            LimaTours
                                        </p>
                                    </td>
