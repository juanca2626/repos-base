...
<head>
    ...
    <title>¡Notificación - Lista de pasajeros actualizada!</title>
</head>
<body>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="full_width">
                                        <tr>
                                            <td valign="top" align="left" mc:edit="module_preheader">
                                                <p><strong>¡Lista de pasajeros actualizada!</strong></p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="full_width"
                            ...
                            <tr>
                                <td style="" align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                                    mc:edit="module_body">
                                    <img src="https://backend.limatours.com.pe/images/banner-lito.jpg" alt="#"
                                         width="100%"
                            ...
                            <tr>
                                <td align="center" valign="top" bgcolor="#ffffff" class="full_width_text"
                                    ...
                                    <div style="margin-bottom: 0rem; padding: 0 1rem;">
                                        <h3 style="padding: 0rem;color: #EB5757; font-size: 1.5rem; font-weight: 700; letter-spacing: 1px;text-align: center;">Lista de pasajeros actualizada</h3>
                                        <p style="font-weight: 500; text-align: left; margin-bottom: 1rem; color: #2E2E2E;">
                                            Buen día, se actualizó la lista de pasajeros:</p>
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 0.5rem; color: #2E2E2E;"><strong style="color: #EB5757;">File:</strong> {{ $data['file']['file_code'] }}</p>
                                        <p style="font-weight: 500; text-align: left; margin-top: 0rem; margin-bottom: 1rem; font-size: 13px;">
                                            <a style="color: #EB5757;" href="https://aurora.limatours.com.pe/register_paxs/{{ $data['file']['file_code'] }}?lang={{ $langs[(int) @$data['user']['lang']] }}&paxs=0&canadl=0&canchd=0&caninf=0">Ver lista de pasajeros</a>
                                        </p>
                                    </div>
                                </td>
                            </tr>
