...
{{--        <h2 style="text-align:center;line-height:24.375px">--}}
        ...
        {{--        </h2>--}}
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(204,2,1)">NOTIFICA INVENTARIO CAMERE - HOTEL {{ $hotel['name'] }}</span>
        </h2>
        <div>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Ciao, abbiamo bisogno della tua collaborazione per inserire gli inventari dell'hotel <b>{{ $hotel['name'] }}</b>, nelle tariffe delle camere:
        <ul>
