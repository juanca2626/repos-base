...
<div style="font-family:verdana,sans-serif">
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Ti ricordiamo che devi completare le informazioni passeggeri della tua prenotazione <b style="color:rgb(204,2,1)">{{ $data['file']['NROREF'] }} - {{ @$data['file']['DESCRI'] }}</b>, il viaggio inizia il&nbsp;<b style="color:rgb(204,2,1)">{{ date("d/m/Y", strtotime($data['file']['DIAIN'])) }}</b>
    </p>
    ...
    <p style="text-align:center">
        <a href="https://aurora.limatours.com.pe/register_paxs/{{ $data['file']['NROREF'] }}?lang=it&paxs={{ $data['file']['CNTMAXPAXS'] }}&canadl={{ $data['file']['CANADL'] }}&canchd={{ $data['file']['CANCHD'] }}&caninf={{ $data['file']['CANINF'] }}"
           target="_blank"
