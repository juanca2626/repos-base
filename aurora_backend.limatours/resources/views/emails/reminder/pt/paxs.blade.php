...
<div style="font-family:verdana,sans-serif">
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Lembramos que você deve preencher os dados do passageiro da sua reserva <b style="color:rgb(204,2,1)">{{ $data['file']['NROREF'] }} - {{ @$data['file']['DESCRI'] }}</b>, a viagem começa em&nbsp;<b style="color:rgb(204,2,1)">{{ date("d/m/Y", strtotime($data['file']['DIAIN'])) }}</b>
    </p>
    ...
    <p style="text-align:center">
        <a href="https://aurora.limatours.com.pe/register_paxs/{{ $data['file']['NROREF'] }}?lang=pt&paxs={{ $data['file']['CNTMAXPAXS'] }}&canadl={{ $data['file']['CANADL'] }}&canchd={{ $data['file']['CANCHD'] }}&caninf={{ $data['file']['CANINF'] }}"
           target="_blank"
