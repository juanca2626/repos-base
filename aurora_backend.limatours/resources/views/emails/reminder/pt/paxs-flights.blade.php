...
<div style="font-family:verdana,sans-serif">
    <span style="color:rgb(80,0,80)">
        ...
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(0,0,0)">LEMBRETE:</span>
        </h2>
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(204,2,1)">COMPLETE OS DETALHES DA SUA RESERVA</span>
        </h2>
        <div>
    ...
    <p style="color:rgb(80,0,80);margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        <span style="color:rgb(0,0,0);font-size:large">Olá {{ $data['file']['RAZONCLI'] }},</span>
        <br>
    </p>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Lembramos que você deve preencher os dados do passageiro / dados dos voos da sua reserva <b style="color:rgb(204,2,1)">{{ $data['file']['NROREF'] }} - {{ @$data['file']['DESCRI'] }}</b>, a viagem começa em&nbsp;<b style="color:rgb(204,2,1)">{{ date("d/m/Y", strtotime($data['file']['DIAIN'])) }}</b>
    </p>

    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Para preencher as informações pendentes, clique no seguinte link:
    </p>

    <p style="text-align:center">
        <a href="https://aurora.limatours.com.pe/register_file/{{ $data['file']['NROREF'] }}?lang=pt&paxs={{ $data['file']['CNTMAXPAXS'] }}&canadl={{ $data['file']['CANADL'] }}&canchd={{ $data['file']['CANCHD'] }}&caninf={{ $data['file']['CANINF'] }}"
           target="_blank"
    ...
    <p style="text-align:center">A equipe LimaTours</p>
</div>
</body>
</html>
