...
{{--        <h2 style="text-align:center;line-height:24.375px">--}}
        ...
        {{--        </h2>--}}
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(204,2,1)">NOTIFICAÇÃO PARA INVENTÁRIO DE QUARTOS - HOTEL {{ $hotel['name'] }}</span>
        </h2>
        <div>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Olá, precisamos da sua colaboração para inserir os estoques del hotel <b>{{ $hotel['name'] }}</b>, nas tarifas dos quartos:
        <ul>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Para completar as informações pendentes, clique no seguinte link:
    </p>
