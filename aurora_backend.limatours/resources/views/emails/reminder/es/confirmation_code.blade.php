...
{{--        </h2>--}}
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(204,2,1)">INGRESA LOS CÓDIGOS DE CONFIRMACIÓN</span>
        </h2>
        <div>
    ...
    <p style="color:rgb(80,0,80);margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        <span style="color:rgb(0,0,0);font-size:large">Hola {{ $data['provider'] }},</span>
        <br>
    </p>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Necesitamos su colaboración para ingresar los códigos de confirmación, le mostraremos un formato en pantalla con las habitaciones por confirmar.
    </p>
    ...
    <p style="text-align:center">
        <a href="{{ $data['link'] }}&lang={{ $data['lang'] }}"
            target="_blank"
