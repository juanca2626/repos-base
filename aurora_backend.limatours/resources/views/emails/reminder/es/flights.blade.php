...
<div style="font-family:verdana,sans-serif">
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Te recordamos que debes completar la informacion de los vuelos de tu reserva <b style="color:rgb(204,2,1)">{{ $data['file']['NROREF'] }} - Smith x 2</b>, el viaje inicia el dia&nbsp;<b style="color:rgb(204,2,1)">{{ date("d/m/Y", strtotime($data['file']['DIAIN'])) }}</b>
    </p>
    ...
    <p style="text-align:center">
        <a href="https://aurora.limatours.com.pe/register_flights/{{ $data['file']['NROREF'] }}?lang=es"
            target="_blank"
