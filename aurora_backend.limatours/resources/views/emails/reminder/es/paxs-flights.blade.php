...
<div style="font-family:verdana,sans-serif">
    <span style="color:rgb(80,0,80)">
        ...
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(204,2,1)">COMPLETA LOS DATOS DE TU RESERVA</span>
        </h2>
        <div>
    ...
    <p style="color:rgb(80,0,80);margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        <span style="color:rgb(0,0,0);font-size:large">Hola {{ $data['file']['RAZONCLI'] }},</span>
        <br>
    </p>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Te recordamos que debes completar la informacion de los pasajeros / informacion de los vuelos de tu reserva <b style="color:rgb(204,2,1)">{{ $data['file']['NROREF'] }} - {{ @$data['file']['DESCRI'] }}</b>, el viaje inicia el dia&nbsp;<b style="color:rgb(204,2,1)">{{ date("d/m/Y", strtotime($data['file']['DIAIN'])) }}</b>
    </p>

    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Para completar la informacion pendientes, haga click en el siguiente enlace:
    </p>

    <p style="text-align:center">
        <a href="https://aurora.limatours.com.pe/register_file/{{ $data['file']['NROREF'] }}?lang=es&paxs={{ $data['file']['CNTMAXPAXS'] }}&canadl={{ $data['file']['CANADL'] }}&canchd={{ $data['file']['CANCHD'] }}&caninf={{ $data['file']['CANINF'] }}"
           target="_blank"
