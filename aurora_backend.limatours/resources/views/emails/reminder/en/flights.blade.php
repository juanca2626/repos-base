...
<div style="font-family:verdana,sans-serif">
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        We remind you that you must complete the information of the flights of your reservation <b style="color:rgb(204,2,1)">{{ $data['file']['NROREF'] }} - {{ @$data['file']['DESCRI'] }}</b>, the trip starts on&nbsp;<b style="color:rgb(204,2,1)">{{ date("d/m/Y", strtotime($data['file']['DIAIN'])) }}</b>
    </p>
    ...
    <p style="text-align:center">
        <a href="https://aurora.limatours.com.pe/register_flights/{{ $data['file']['NROREF'] }}?lang=en"
           target="_blank"
