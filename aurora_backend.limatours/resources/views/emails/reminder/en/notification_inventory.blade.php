...
{{--        <h2 style="text-align:center;line-height:24.375px">--}}
        ...
        {{--        </h2>--}}
        <h2 style="text-align:center;line-height:24.375px">
            <span style="color:rgb(204,2,1)">NOTIFICATION FOR ROOM INVENTORY - HOTEL {{ $hotel['name'] }}</span>
        </h2>
        <div>
    ...
    <p style="margin:0cm 0cm 8pt;font-family:Calibri,sans-serif;text-align:center;line-height:13.91px">
        Hi, we need your collaboration to enter the inventories of the hotel <b>{{ $hotel['name'] }}</b>, in the room rates:
        <ul>
