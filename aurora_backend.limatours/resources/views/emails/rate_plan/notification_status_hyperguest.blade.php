                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 16px; font-weight: bold; text-align: left;">
                                        Buen día estimados,
                                        {{ $data['user'] }} se desactivo la tarifa {{ $data["rate_plan_name"] }}, del hotel: {{ $data['hotel']  }}
                                        sin embargo para dicha tarifa el sistema reconoce que está siendo utilizado en las cotizaciones de los siguientes paquetes en lista. Por favor, revise y reemplace o elimine esta tarifa de las cotizaciones correspondientes, ya que se encuentra actualmente inactiva.</h1>
