                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 16px; font-weight: bold; text-align: left;">
                                        Buen día estimados,
                                        {{ $data['user'] }} requiere desactivar la habitación {{ $data["rate_plan_name"] }}, del hotel: {{ $data['hotel']  }}
                                        sin embargo para dicha habitación el sistema reconoce que está siendo utilizado en las cotizaciones de los siguientes paquetes en lista, ud. dispone de las próximas 48 horas para su revisión. (Por favor reemplazar o quitar de las siguientes cotizaciones de paquetes ya que luego de ese tiempo será desactivado automáticamente).</h1>
                                        ...
                                        @foreach( $data['packages'] as $pack )
                                            <tr>
                                                ...
                                                @foreach( $pack['categories'] as $category )
                                                    <span style="margin-left: 10px; border-radius: 5px; color: #fff; background-color: #BD0D12;">
                                                        {{ $category }}
                                                    </span>
                                                    <br>
                                                @endforeach
