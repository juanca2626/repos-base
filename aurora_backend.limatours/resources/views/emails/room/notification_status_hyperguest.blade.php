                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 16px; font-weight: bold; text-align: left;">
                                        Buen día estimados,
                                        {{ $data['user'] }} se desactivo la habitación {{ $data["room_name"] }}, del hotel: {{ $data['hotel']  }}
                                        Sin embargo, el sistema reconoce que dicha habitación aún está siendo utilizada en las cotizaciones de los siguientes paquetes listados. Por favor, revise y reemplace o elimine esta habitación de las cotizaciones correspondientes, ya que se encuentra actualmente inactiva.</h1>
