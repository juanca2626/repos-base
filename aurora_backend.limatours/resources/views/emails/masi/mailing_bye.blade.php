...
$lang = $data['idioma'];
$encuesta = $items['poll'];
$colorText = ($data['color'] !== '#D68F02') ? $data['color'] : '#bd0a10';
                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 5px; padding-left: 5px;">
                                           ...
                                           padding-top: 20px;
                                            ...
                                            text-align:left;">
                                                ...
                                                <?php echo $textFontSize; ?>
                                                    line-height: 17px;
                                                    text-align: center">
                                                    <span style="font-size: 20px; line-height: 24px;"><strong>{{ __('masi.texto_cuentanos_subre_tu_viaje') }}</strong></span>
                                                </p>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="divider "
                                        ...
                                        <tr style="vertical-align: top">
                                            <td class="divider_inner"
                                                style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;padding-right: 10px;padding-left: 10px;padding-top: 20px;padding-bottom: 10px;min-width: 100%;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                    ...
                                    <div class="">
                                        ...
                                        <![endif]-->
                                        <div style="color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <span style="font-size: 12px; line-height: 15px;word-spacing: 1px;"><strong>{{ __('masi.text_hola') }} <?php echo urldecode($items['paxName']); ?></strong>, {{ __('masi.text_graciasporsu') }}</span><span
                                                        style="font-size: 12px; line-height: 15px;"></span></p>
                                            </div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                    ...
                                    <div class="">
                                        ...
                                        <![endif]-->
                                        <div style="color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 15px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <span style="font-size: 12px; line-height: 15px;word-spacing: 1px;">
                                                        {{ __('masi.text_apreciaremos_1') }}
                                                        <span>
                                                            <a href="<?php echo $encuesta; ?>" style="color: #C38D22 !important;text-decoration: none;">{{ __('masi.text_apreciaremos_2') }}</a>
                                                        </span>
                                                        {{ __('masi.text_apreciaremos_3') }}
                                                    </span>
                                                    <span
                                                        style="font-size: 12px; line-height: 15px;"></span></p>
                                            </div>
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                        ...
                                        <div style="color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 15px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                       ...
                                                       mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 100%;
                                                       -ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                    <tbody>
                                                    <tr>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">

                                                            <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556139747/aurora/mailing/_.png">
                                                        </td>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">
                                                            <a style="color: #868383;text-decoration: none;" href="<?php echo $encuesta; ?>">
                                                                <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556139747/aurora/mailing/ENCUESTA1.png" alt="1">
                                                                <p>1</p>
                                                            </a>
                                                        </td>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">
                                                            <a style="color: #868383;text-decoration: none;" href="<?php echo $encuesta; ?>">
                                                                <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556139747/aurora/mailing/ENCUESTA2.png" alt="2">
                                                                <p>2</p>
                                                            </a>
                                                        </td>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">
                                                            <a style="color: #868383;text-decoration: none;" href="<?php echo $encuesta; ?>">
                                                                <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556139746/aurora/mailing/ENCUESTA3.png" alt="3">
                                                                <p>3</p>
                                                            </a>
                                                        </td>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">
                                                            <a style="color: #868383;text-decoration: none;" href="<?php echo $encuesta; ?>">
                                                                <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556139746/aurora/mailing/ENCUESTA4.png" alt="4">
                                                                <p>4</p>
                                                            </a>
                                                        </td>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">
                                                            <a style="color: #868383;text-decoration: none;" href="<?php echo $encuesta; ?>">
                                                                <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556139746/aurora/mailing/ENCUESTA5.png" alt="5">
                                                                <p>5</p>
                                                            </a>
                                                        </td>
                                                        <td style="width: 10px;text-align: center;font-family: Arial,'Helvetica Neue',Helvetica,sans-serif;font-weight: bold;color: #868383;">
                                                            <img src="https://res.cloudinary.com/litomarketing/image/upload/v1556163941/aurora/mailing/mas.png">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                    ...
                                    <div class="">
                                     ...
                                     padding-top: 10px;
                                      padding-bottom: 10px;">
                                        <![endif]-->
                                        <div style="color:#5b5b75;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;
                            line-height:120%;
                             padding-right: 10px;
                              padding-left: 10px;
                               padding-top: 20px;
                             ...
                             padding-top: 10px;
                              padding-bottom: 10px;">
                                ...
                                text-align:left;">
                                    ...
                                    line-height: 17px;
                                    text-align: center">
                                      <span style="color: rgb(188, 10, 16);
                                      font-size: 13px;
                                       line-height: 15px;">
                                            ...
                                            text-align:left;padding-top: 10px;">
                                                                        <p style="margin: 0;text-align: center;margin-bottom: 0px;">
                                                                            <a href="mailto:{{ __('masi.text_email') }}"
                                                                               style="text-decoration: none">
                                                                                <img src="https://res.cloudinary.com/litodti/image/upload/v1725471281/MASI/Icon_Mail.png" alt="">
                                                                            </a>
                                                                        </p>
                                                                        <p style="margin: 0;font-size: 13px;line-height: 17px;text-align: center">
                                                                            <b style="color: #5b5b75; font-size: 12px; line-height: 16px;">
                                        ...
                                        line-height:120%;
                                         padding-right: 10px;
                                          ...
                                          border-right: solid 1px #CBCBCC;">
                                            ...
                                            text-align:left;padding-top: 10px;">
                                                                        <p style="margin: 0;text-align: center;margin-bottom: 0px;">
                                                                            <a href="https://api.whatsapp.com/send?phone={{ __('masi.text_whatsapp_alt') }}" style="text-decoration: none;">
                                                                                <img src="https://res.cloudinary.com/litodti/image/upload/v1725471283/MASI/Icon_WhatsApp.png" alt="">
                                                                            </a>
                                                                        </p>
                                                                        <p style="margin: 0;font-size: 13px;line-height: 17px;text-align: center">
                                                                            <b style="color: #5b5b75; font-size: 12px; line-height: 16px;">
                                            ...
                                            text-align:left;padding-top: 10px;">
                                                                        <p style="margin: 0;text-align: center;margin-bottom: 0px;">
                                                                            <a href="tel:{{ __('masi.text_celular_alt') }}"
                                                                               style="text-decoration: none;">
                                                                                <img src="https://res.cloudinary.com/litodti/image/upload/v1725471281/MASI/Icon_Phone.png" alt="">
                                                                            </a>
                                                                        </p>
                                                                        <p style="margin: 0;font-size: 13px;line-height: 17px;text-align: center">
                                                                            <b style="color: #5b5b75; font-size: 12px; line-height: 16px;">
