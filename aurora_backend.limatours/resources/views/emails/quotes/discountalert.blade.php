                            ...
                            <table style="width: 100%; max-width: 660px; margin: 0 auto; padding: 0;" align="center" width="660" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                        <!-- Greeting -->
                                        <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">Alerta de descuento superior a 3%</h1>

                                        <!-- Intro -->
                                        <p style="margin-top: 0; color: #74787E; font-size: 19px; line-height: 1.5em; text-align: center;">
                                            El usuario {{ $user_from }}, ha exportado tarifas en excel de su cotización N° {{ $quote_id }} - "{{ $quote_name }}"
                                            con un descuento del {{ $quote_discount }}%, motivo ingresado: "{{ $quote_discount_detail }}".
                                        </p>
