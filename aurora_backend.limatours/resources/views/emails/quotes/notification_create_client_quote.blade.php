                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em; text-align: left;">
                                        {{ trans('quote.customer_has_created_a_new_quote',['client_code' => $quote['client']['code']]) }}
                                    </p>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" width="100%" height="40"
                                                            ...
                                                            <table
                                                                ...
                                                                <tr>
                                                                    <td><b>{{ trans('quote.quotation') }}
                                                                            N°: {{$quote['quote']['id']}} </b></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>{{ trans('quote.date') }}
                                                                            : {{$quote['quote']['date_in']}}</b></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>{{ trans('quote.name') }}
                                                                            : {{$quote['quote']['name']}}</b></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
