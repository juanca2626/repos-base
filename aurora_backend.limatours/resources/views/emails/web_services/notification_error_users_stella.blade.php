                ...
                <tr>
                    <td style="width: 100%; margin: 0; padding: 0; border-top: 1px solid #EDEFF2; border-bottom: 1px solid #EDEFF2; background-color: #FFF;"
                        ...
                        <table style="width: 100%; max-width: 660px; margin: 0 auto; padding: 0;" align="center"
                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <h1 style="margin-top: 0; font-size: 19px; font-weight: bold; text-align: left;">
                                        Hola {{$reservation['executive']['name']}} <br /> 
                                        No se pudo procesar el File: {{$reservation->file_code}} del cliente {{$reservation['client']['name']}}.
                                        
                                    {{-- porque el proceso  
                                    
                                    @if($reservation['status_cron_job_reservation_stella'] == 1)
                                        <b>Creación de datos de facturación</b>
                                    @endif
                                    @if($reservation['status_cron_job_reservation_stella'] == 2)
                                        <b>Creación de File</b>
                                    @endif
                                    @if($reservation['status_cron_job_reservation_stella'] == 3)
                                        <b>Creación de asiento contable</b>
                                    @endif                                    

                                    ha fallado.  --}} </h1>
                                
                                    <br />
                                    Por favor te pedimos que cierres el file {{$reservation->file_code}} si lo estás editando para que el proceso se ejecute correctamente
                                    y dale click en procesar nuevamente y esperar que le llegue las notificaciones de confirmación de las reservas. 
                            ...
                            <tr>
                                <td align="center">
                                    <a href="{{ url('/') }}/reservations/{{base64_encode($reservation->id)}}" class="button">Procesar nuevamente</a>
                                    <br /> <br /> <br /> 
                                </td>
                            </tr>
