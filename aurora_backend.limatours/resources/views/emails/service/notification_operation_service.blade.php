                                ...
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em; text-align: left;">
                                        ...
                                        @if($data['action'] === 'create')
                                            ha creado la operatividad
                                        @else
                                            ha modificado una operatividad
                                        @endif
                                    </p>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" width="100%" height="40"
                                                            ...
                                                            <table
                                                                ...
                                                                <tr>
                                                                    <td><b>Servicio [ID - Codigo Aurora]:</b></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>{{ $data['service_id'] }}
                                                                        - {{ $data['aurora_code'] }}</td>
                                                                ...
                                                                @if (count($data['operations']) > 0)
                                                                    @if (isset($data['operations']['day']))
                                                                        <tr>
                                                                            <td><b>Día:</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ $data['operations']['day'] }} </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if (isset($data['operations']['start_time']))
                                                                        <tr>
                                                                            <td><b>Hora de salida:</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ $data['operations']['start_time'] }} </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if (isset($data['operations']['shifts_available']))
                                                                        <tr>
                                                                            <td><b>Turno disponible:</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ $data['operations']['shifts_available'] }} </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if (isset($data['operations']['sshh_available']))
                                                                        <tr>
                                                                            <td><b>Disponibilidad de SSHH en ruta:</b>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            @if ($data['operations']['sshh_available'])
                                                                                <td>Si</td>
                                                                            @else
                                                                                <td>No</td>
                                                                            @endif
                                                            ...
                                                            @if (count($data['operation_details']) > 0)
                                                                <table
                                                                    style="width: 600px; margin: 0 auto; background: #ffffff;">
                                                                    <tr>
                                                                        @if($data['action'] === 'create')
                                                                            <td><b>Se agrego una operativida para el
                                                                                    dia:</b></td>
                                                                            @else
                                                                            <td>
                                                                                <b>
                                                                                    ID {{$data['operation_details']['id']}}:
                                                                                    <br> Se modifico una operativida para el
                                                                                    dia
                                                                                </b>
                                                                            </td>
                                                                        @endif
                                                                    ...
                                                                    <tr>
                                                                        <td>{{$data['operation_details']['day']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Operatividad</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>{{$data['operation_details']['service_type_activity']}}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><b>Minutos</b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>{{$data['operation_details']['minutes']}}</td>
                                                                    </tr>
                                                                </table>
                                                            @endif
                                                        </td>
