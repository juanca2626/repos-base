                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 16px; font-weight: bold; text-align: left;">
                                        Buen día estimados,
                                        {{ $data['user'] }} requiere desactivar el servicio {{ $data["service_name"] }}, sin embargo para dicho servicio el sistema reconoce que está siendo utilizado en otros servicios (sección de Suplementos) plasmados en lista, ud. dispone de las próximas 72 horas para su revisión. (Por favor reemplazar o quitar, ya que luego de ese tiempo será desactivado automáticamente).</h1>
