                                                        ...
                                                        <td valign="middle" width="100%" height="40"
                                                            ...
                                                            <table
                                                                ...
                                                                @if (count($data['inclusions']) > 0)
                                                                    @if (isset($data['inclusions']['day']))
                                                                        <tr>
                                                                            <td><b>Día:</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ $data['inclusions']['day'] }} </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if (isset($data['inclusions']['inclusion_id']))
                                                                        <tr>
                                                                            <td><b>Inclusion:</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>{{ $data['inclusions']['inclusion_id'] }} </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if (isset($data['inclusions']['include']))
                                                                        <tr>
                                                                            <td><b>Incluye (Si/No):</b></td>
                                                                        </tr>
                                                                        <tr>
                                                                            @if ($data['inclusions']['include'] == 1)
                                                                                <td>Si</td>
                                                                            @else
                                                                                <td>No</td>
                                                                            @endif
                                                                    ...
                                                                    @endif
                                                                    @if (isset($data['inclusions']['see_client']))
                                                                        <tr>
                                                                            <td><b>Ver client (Si/No):</b>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            @if ($data['inclusions']['see_client'])
                                                                                <td>Si</td>
                                                                            @else
                                                                                <td>No</td>
                                                                            @endif
