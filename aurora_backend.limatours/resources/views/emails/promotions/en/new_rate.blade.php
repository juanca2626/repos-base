                            ...
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    ...
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                        Tarifa Promocional Nueva:</h1>

                                    <!-- User -->
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em; text-align: left;">
                                        Hola a todos,<br />

                                        Les informamos que contamos con una tarifa "{{ $data['rate']['name'] }}" para el hotel {{ $data['hotel']['name'] }}, la cual pueden encontrar como Tarifa {{ $data['rate']['translations'][0]['value'] }}<br />

                                        - Válida para reservar desde: {{ $data['rate']['promotions_data'][(count($data['rate']['promotions_data']) - 1)]['promotion_from'] }} hasta {{ $data['rate']['promotions_data'][(count($data['rate']['promotions_data']) - 1)]['promotion_to'] }}<br />

                                        - Para que sea válida debe ir con el código: {{ $data['rate']['code'] }}
                                    </p>
