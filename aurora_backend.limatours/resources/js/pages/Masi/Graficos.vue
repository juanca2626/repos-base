<template>
    <div>
                                ...
                                <div class="card text-white bg-primary">
                                    ...
                                    <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="card-chart1" height="87"
                                            width="242" style="display: block; height: 70px; width: 194px;"></canvas>
                                        <div id="card-chart1-tooltip" class="chartjs-tooltip top bottom"
                                            style="opacity: 0; left: 113.558px; top: 93.2778px;">
                                ...
                                <div class="card text-white bg-info">
                                    ...
                                    <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                                        ...
                                        <div id="card-chart2-tooltip" class="chartjs-tooltip top"
                                            style="opacity: 0; left: 52.5576px; top: 115.837px;">
                                            <div class="tooltip-header">
                                            ...
                                            <div class="tooltip-body">
                                                <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                                                        ...
                                                        class="tooltip-body-item-label">My First dataset</span><span
                                                        class="tooltip-body-item-value">18</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card text-white bg-warning">
                                    ...
                                    <div class="chart-wrapper mt-3" style="height:70px;">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="card-chart3" height="87"
                                            width="282" style="display: block; height: 70px; width: 226px;"></canvas>
                                        <div id="card-chart3-tooltip" class="chartjs-tooltip top"
                                            style="opacity: 0; left: 97px; top: 102px;">
                                            <div class="tooltip-header">
                                            ...
                                            <div class="tooltip-body">
                                                <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                                                        ...
                                                        class="tooltip-body-item-label">My First dataset</span><span
                                                        class="tooltip-body-item-value">80</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="chart-wrapper" style="height:300px;margin-top:40px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="main-chart" height="375"
                                        width="1197" style="display: block; height: 300px; width: 958px;"></canvas>
                                    <div id="main-chart-tooltip" class="chartjs-tooltip center"
                                        style="opacity: 0; left: 145.021px; top: 267.6px;">
                                        <div class="tooltip-header">
                                        ...
                                        <div class="tooltip-body">
                                            <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                                                    ...
                                                    class="tooltip-body-item-label">My First dataset</span><span
                                                    class="tooltip-body-item-value">69</span></div>
                                            <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                                                    style="background-color: rgb(255, 255, 255);"></span><span
                                                    class="tooltip-body-item-label">My Second dataset</span><span
                                                    class="tooltip-body-item-value">100</span></div>
                                            <div class="tooltip-body-item"><span class="tooltip-body-item-color"
                                                    style="background-color: rgb(255, 255, 255);"></span><span
                                ...
                                <div class="brand-card">
                                    <div class="brand-card-header bg-facebook">
                                        ...
                                        <div class="chart-wrapper">
                                            ...
                                            <canvas id="social-box-chart-1" height="120" width="282"
                                                class="chartjs-render-monitor"
                                                style="display: block; height: 96px; width: 226px;"></canvas>
                                        </div>
                                    </div>
                                ...
                                <div class="brand-card">
                                    <div class="brand-card-header bg-twitter">
                                        ...
                                        <div class="chart-wrapper">
                                            ...
                                            <canvas id="social-box-chart-2" height="120" width="282"
                                                class="chartjs-render-monitor"
                                                style="display: block; height: 96px; width: 226px;"></canvas>
                                        </div>
                                    </div>
                                ...
                                <div class="brand-card">
                                    <div class="brand-card-header bg-linkedin">
                                        ...
                                        <div class="chart-wrapper">
                                            ...
                                            <canvas id="social-box-chart-3" height="120" width="282"
                                                class="chartjs-render-monitor"
                                                style="display: block; height: 96px; width: 226px;"></canvas>
                                        </div>
                                    </div>
                                ...
                                <div class="brand-card">
                                    <div class="brand-card-header bg-google-plus">
                                        ...
                                        <div class="chart-wrapper">
                                            ...
                                            <canvas id="social-box-chart-4" height="120" width="282"
                                                class="chartjs-render-monitor"
                                                style="display: block; height: 96px; width: 226px;"></canvas>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-responsive-sm table-hover table-outline mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <i class="flag-icon flag-icon-us h4 mb-0" id="us"
                                                            title="us"></i>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <i class="flag-icon flag-icon-br h4 mb-0" id="br"
                                                            title="br"></i>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <i class="flag-icon flag-icon-in h4 mb-0" id="in"
                                                            title="in"></i>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <i class="flag-icon flag-icon-fr h4 mb-0" id="fr"
                                                            title="fr"></i>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <i class="flag-icon flag-icon-es h4 mb-0" id="es"
                                                            title="es"></i>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <i class="flag-icon flag-icon-pl h4 mb-0" id="pl"
                                                            title="pl"></i>
                                                    </td>
                                                    <td>
                                                        <div class="clearfix">
        ...
        <!--
        <div class="card mb-3 mt-3" v-for="(item, index) in groups" :key="index">
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            getMasi: function() {
                let url = 'http://localhost:9000/masi/api/poll/results'
                axios.get(url)
                .then(response => {
