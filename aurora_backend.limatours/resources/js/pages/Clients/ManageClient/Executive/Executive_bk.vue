    ...
    <div class="row col-12">
        ...
        <div class="col-5">
            <label class="col-sm-12 col-form-label" for="period">{{
                $t('clientsmanageclientexecutive.available_executives') }}</label>
          ...
          <ul class="style_list_ul" id="list_executives">
              <draggable :list="executives">
                  <li :class="{'style_list_li':true, 'item':true, 'selected':executive.selected}" :id="'executive_'+index"
                      @click="selectExecutive(executive, index)" v-for="(executive, index) in executives">
                      <span class="style_span_li">{{ executive.name}}</span>
                  </li>
              </draggable>
          </ul>
        </div>
        ...
        <div class="col-5">
            ...
            <div class="input-group">
                ...
                <input class="form-control" id="search_executives_selected" type="search" v-model="query_executives_selected"
                       value="">
            </div>
            <ul class="style_list_ul" id="list_executives_selected">
                <draggable :list="executives_selected" class="list-group">
                    <li :class="{'style_list_li':true, 'item':true, 'selected':executive.selected}"
                        @click="selectExecutiveExecutivesSelected(executive,index)" v-for="(executive,index) in executives_selected">
                        <span class="style_span_li">{{ executive.name}}</span>
                    </li>
                </draggable>
            </ul>
...
<script>
  ...
  export default {
    ...
    mounted: function () {
        ...
        console.log('Region ID inicial:', this.$route.params.region_id);
    },
    // created: function() {
    //     this.$root.$on('region-changed', (regionId) => {
    //         console.log('Region ID cambió:', regionId);
    //         // this.getExecutives();
    //         // this.getExecutivesSelected();
    //     });
    // },
    methods: {
        ...
        if (this.loading === false) {
          ...
          if (search_executive !== -1) {
            API({
              ...
              data: this.executives[search_executive]
            })
              .then((result) => {
        ...
        if (this.loading === false) {
          ...
          if (search_executive !== -1) {
            ...
            API({
              ...
              data: this.executives_selected[search_executive]
            })
              .then((result) => {
                if (result.data.success === true) {
                  this.getExecutives()
      ...
      getScrollTop: function () {
        let scroll = document.getElementById('list_executives').scrollTop
      ...
      getScrollTopExecutivesSelected: function () {
        let scroll = document.getElementById('list_executives_selected').scrollTop
      ...
      getExecutives: function () {
        API({
          ...
          .then((result) => {
            console.log("resultado de la data")
            console.log("resultado de la data")
            console.log(result)
            ...
            document.getElementById('list_executives').scrollTop = 0
      ...
      getExecutivesSelected: function () {
        API({
          ...
          .then((result) => {
            ...
            document.getElementById('list_executives_selected').scrollTop = 0
