    ...
    <div class="row">
        <div class="col-sm-12">
            <form @submit.prevent="validateBeforeSubmit">
                ...
                <div class="b-form-group form-group">
                    <div class="form-row">
                        <label class="col-sm-2 col-form-label" for="surname">{{
                            $t('hotelsmanagehotelinformation.surname') }}</label>
                        <div class="col-sm-5">
                            <input :class="{'form-control':true, 'is-valid':validError, 'is-invalid':invalidError }"
                ...
                <div class="b-form-group form-group">
                    <div class="form-row">
                        <label class="col-sm-2 col-form-label" for="lastname">{{
                            $t('hotelsmanagehotelinformation.lastname') }}</label>
                        <div class="col-sm-5">
                            <input :class="{'form-control':true, 'is-valid':validError, 'is-invalid':invalidError }"
                ...
                <div class="b-form-group form-group">
                    <div class="form-row">
                        <label class="col-sm-2 col-form-label" for="email">{{ $t('hotelsmanagehotelinformation.email')
                            }}</label>
                        <div class="col-sm-5">
                            <input :class="{'form-control':true, 'is-valid':validError, 'is-invalid':invalidError }"
                                   data-vv-as="email" id="email"
                                   name="email" @change="removeAccents()"
                ...
                <div class="b-form-group form-group">
                    <div class="form-row">
                        <label class="col-sm-2 col-form-label" for="position">{{
                            $t('hotelsmanagehotelinformation.position') }}</label>
                        <div class="col-sm-5">
                            <input :class="{'form-control':true, 'is-valid':validError, 'is-invalid':invalidError }"
                ...
                <div class="b-form-group form-group">
                    <div class="form-row">
                        <label class="col-sm-4 col-form-label">{{ $t('hotelsmanagehotelinformation.principal')
                            }}</label>
                        <div class="col-sm-2 mt-1">
                            <c-switch id="principal" class="mx-1" color="primary"
          ...
          .then((result) => {
            if (result.data.success === false) {
              ...
              this.$notify({
                ...
                type: 'error',
                title: this.$t('global.modules.contacts'),
                text: this.$t('hotelsmanagehotelinformation.error.messages.contact_incorrect')
              })
