...
class CreatePackageDynamicSaleRatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('package_dynamic_sale_rates', function (Blueprint $table) {
            ...
            $table->foreign('package_rate_sale_markup_id')->references('id')->on('package_rate_sale_markups');
        });
    }
    ...
    {
        Schema::dropIfExists('package_dynamic_sale_rates');
    }
}
