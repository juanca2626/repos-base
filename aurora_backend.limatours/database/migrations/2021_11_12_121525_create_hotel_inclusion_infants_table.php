...
class CreateHotelInclusionInfantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hotel_inclusion_infants', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hotel_inclusion_infants');
    }
}
