...
class Inventory extends Model
{
    ...
    public static function list($hotel_id, $lang, $allotment, $room_id, $rate_plan_id, $client_id, $year, $month): array
    {
        ...
        if ($allotment === 0 && $rate_plan_id == null) {
            $bags = Bag::where('hotel_id', $hotel_id)->where('status', 1)
                ->with([
                    'bag_rooms' => function ($query) use ($room_ids, $lang) {
    ...
    public static function checkExists($inventories_exists_group, $rate_plan_rooms_id, $day)
    {
    ...
    public static function checkExistsBag($inventories_bag_exists_group, $bag_room_id, $day)
    {
