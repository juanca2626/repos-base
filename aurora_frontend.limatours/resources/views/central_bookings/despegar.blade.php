                    ...
                    <div class="table-responsive-sm">
                        <table class="table text-center canSelectText">
                            ...
                            <tr v-for="booking in bookings">
                                ...
                                <td class="td-body">@{{booking.date_from | formatDate}} | @{{booking.date_to | formatDate}}</td>
                                <td class="td-body">
                                    <span v-if="booking.adults>0">@{{booking.adults}} <strong>ADL</strong></span>
                                    <span v-if="booking.children>0">@{{booking.children}} <strong>+ CHD</strong></span>
                                    <span v-if="booking.infants>0">@{{booking.infants}} <strong>+ INF</strong></span>
                                </td>
        ...
        new Vue({
            ...
            methods: {
                saveBookingStatus: function (booking_id) {
                    ...
                    this.loading = true
                    axios.post('/api/channel/despegar/'+booking_id+'/status_external', this.flag_booking_status)
                        .then((result) => {
                ...
                removeHomologation(h) {
                    axios.delete('/api/channel/despegar/homologation/'+h.id)
                        .then((result) => {
                            if(result.data.success){
                ...
                saveHomologation(){
                    ...
                    axios.post('/api/channel/despegar/homologations', this.formHomologation)
                        .then((result) => {
                            if(result.data.success){
                ...
                searchHomologations(){
                    ...
                    axios.get('/api/channel/despegar/homologations')
                        .then((result) => {
                            if(result.data.success){
                ...
                toggleStatus(id, status) {
                    this.loading = true
                    axios.post('/api/channel/despegar/'+id+'/status', { status : status })
                        .then((result) => {
                            if(result.data.success){
                                this.onUpdate()
                            }
                ...
                onUpdate () {
                    this.loading = true
                    this.urlbookings = '/api/channel/despegar/list?filterBy='+this.checkViewClosed +
                ...
                newFile : function(typeCreation){
                    ...
                    if( err==0 ){
                        ...
                        if( err == 0 ){
                            ...
                            axios({
                                method: 'post',
                                url: '/api/channel/despegar/reserve',
                                data: data
                            })
                                .then((result) => {
                                    console.log(result)
