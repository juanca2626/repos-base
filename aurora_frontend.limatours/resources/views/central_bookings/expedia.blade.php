        ...
        new Vue({
            ...
            methods: {
                saveBookingStatus: function (_booking) {
                    ...
                    this.loading = true
                    axios.post('/api/channel/expedia/'+this.bookings[_booking].id+'/status_external', {
                ...
                saveBookingService: function (_booking) {
                    ...
                    this.loading = true
                    axios.post('/api/channel/expedia/'+this.bookings[_booking].id+'/service', {
                ...
                toggleStatus(id, status) {
                    this.loading = true
                    axios.post('/api/channel/expedia/'+id+'/status', { status : status })
                        .then((result) => {
                            if(result.data.success){
                                this.onUpdate()
                            }
                ...
                onUpdate () {
                    this.loading = true
                    this.urlbookings = 'api/channel/expedia/list?filterBy='+this.checkViewClosed +
                ...
                newFile : function(typeCreation){
                    ...
                    if( err==0 ){
                        ...
                        if( err == 0 ){
                            ...
                            axios({
                                method: 'post',
                                url: '/api/channel/expedia/reserve',
                                data: data
                            })
                                .then((result) => {
                                    console.log(result)
