                ...
                <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;" href="{{ url('/') }}" target="_blank">
                            <img src="{{ asset('/images/logo/logo_nav.jpg') }}" width="300" title="LimaTours" alt="LimaTours">
                        </a>
                    </td>
                </tr>
                        ...
                        <table style="width: 100%; max-width: 660px; margin: 0 auto; padding: 0;" align="center" width="660" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                                    <!-- Greeting -->
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">Pasajeros pendientes de Información FILE: {{ $data['file'] }}</h1>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" align="center" class="buttonScale">
                                                    <tr>
                                                        <td valign="middle" width="100%" height="40" style="text-align: left; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: rgb(50, 50, 50); font-size: 17px; font-weight: 300; line-height: 30px;" class="fullCenter" mc:edit="8" >
                                                            A una semana de la llegada de sus pasajeros a Perú, le pedimos por favor registrar los datos pendientes del file en referencia con fecha in {{ $data['datein'] }}. Es de suma importancia para nosotros tener estos datos para poder realizar las reservas correspondientes.<br />
                                                            <?php $items = ['data' => ['action' => 'modalPassengers', 'file' => $data['file'], 'paxs' => $data['paxs'], 'token' => sha1($data['file'] . $data['paxs'])]]; ?>
                                                            Haga <a href="{{ url('/board?' . http_build_query($items)) }}" target="_blank">click aquí</a> para completar la información.<br /><br />
                                                            Muchas Gracias,<br />
                                                            {{ $data['nomeje'] }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center" height="40" bgcolor="#be311a"style=" padding-left: 25px; padding-right: 25px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); font-size: 13px; font-weight: 700; line-height: 1px; background-color: #be311a;">
                                                            <a href="{{ url('/') }}"  style="color: rgb(255, 255, 255); text-decoration: none; width: 100%;">LimaTours</a>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
