    ...
    <div>
        ...
        <div class="container-fluid">
            <fusioncharts v-if="!loading"
                          id="mychartcontainer-files"
                          chartid="vueChart-files"
                          width="100%"
                          height="500"
...
<script>
    ...
    export default {
        ...
        mounted: function() {
            ...
            FusionCharts.addEventListener('dataPlotClick', this.handler_files)
                    ...
                    axios.post(
                        ...
                        .then((result) => {
                            ...
                            Object.entries(_response).forEach(([i, item]) => {
                                ...
                                vm.excepciones_7 += _dashboard.response_7.files['EXCEPCIONES'].length
                                vm.excepciones_15 += _dashboard.response_15.files['EXCEPCIONES'].length
                                vm.excepciones_30 += _dashboard.response_30.files['EXCEPCIONES'].length
                                vm.excepciones_mes += _dashboard.response_mes.files['EXCEPCIONES'].length
