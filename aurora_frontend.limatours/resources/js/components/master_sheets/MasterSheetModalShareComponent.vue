<template>
    <div class="modal fade modal-general modal-info" id="modal-compartir">
...
<!--                            <div class="icono icon-user"></div>-->
                ...
                <div class="modal-body" style="padding: 0 !important; border-radius: 0 !important;">
                    <div class="modal-body-enlace">
                        <div class="modal-info-editar" style="margin: 6px;">
                            <div class="enlace-content">
                                ...
                                <a :href="baseURL + 'master-sheet/' + link_encode" target="_blank" id="link_for_copy">{{ baseURL }}master-sheet/{{ link_encode }}</a>
    ...
    export default {
        ...
        methods: {
            load() {
                ...
                // btoa - atob
                this.link_encode = btoa(this.data.master_sheet_id)
                this.search()
            },
            will_remove(){
            ...
            remove(share_id){
                axios.delete(
                    baseExternalURL + 'api/master_sheet/user/' + share_id
                )
                    .then((result) => {
            ...
            save(){
                ...
                let data = {
                    master_sheet_id: this.master_sheet_id,
                    user_ids: _user_ids,
                ...
                axios.post(
                    baseExternalURL + 'api/master_sheet/user', data
                )
                    .then((result) => {
                        if( result.data.success ){
            ...
            search() {
                ...
                axios.get(
                    baseExternalURL + 'api/master_sheet/'+this.data.master_sheet_id+'/users'
                )
                    .then((result) => {
                        if( result.data.success ){
