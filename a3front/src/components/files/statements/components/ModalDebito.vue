      ...
      <div class="modal-container">
        ...
        <div class="modal-header">
          <div class="title-section">
            ...
            <span class="modal-title text-uppercase">{{ t('global.label.debit_note') }}</span>
          </div>
        </div>
...
<script setup>
  ...
  const handleProcess = async () => {
    await filesStore.storeDebitNote(filesStore.getFile.id, items.value);
