                  ...
                  <a-row type="flex" align="middle" justify="start">
                    <a-col>
                      <template v-if="rate.onRequest == 1">
                        <a-tag
                          class="d-flex ant-row-middle bg-success text-white py-2"
                      ...
                      <template v-else>
                        <a-tag
                          class="d-flex ant-row-middle bg-warning text-white py-2"
                          style="border: transparent"
                        >
