                ...
                <div class="translation-tab-content edit-content-form">
                  ...
                  <div class="edit-content-section">
                    ...
                    <div class="itinerary-original-text">
                      {{ getTranslationByLang(lang.key)?.translation_itinerary || '' }}
                    </div>
                  </div>
                ...
                <div class="translation-tab-content">
                  ...
                  <a-card size="small" class="card-itinerary-translation">
                    ...
                    <div class="card-itinerary-content">
                      <!-- Texto original (sin label) -->
                      <div class="itinerary-original-text">{{ itineraryOriginal }}</div>
                      ...
                      <div class="translation-field mt-4">
                        <span class="translation-field-label translation-field-label-section"
                          >Calificación de la traducción para el itinerario</span
                        >
                        <a-radio-group
                          :value="getTranslationByLang(lang.key)?.qualification_itinerary_id"
                          @change="
                            (e: any) => updateQualificationItinerary(lang.key, e.target?.value ?? e)
                          "
                          class="translation-radio-group"
                        >
                          <a-radio
                      ...
                      <div
                        v-if="getTranslationByLang(lang.key)?.qualification_itinerary_id !== 4"
                      ...
                      >
                        ...
                        <div class="editor-container">
                          <EditorQuillComponent
                            :model-value="
                              getTranslationByLang(lang.key)?.translation_itinerary_correct || ''
                            "
                            @update:model-value="
                              (val: string) => updateTranslationItineraryCorrect(lang.key, val)
                            "
                            placeholder=""
                            class="custom-editor"
                            :max-length="1000"
...
<script setup lang="ts">
  ...
  import { useGenericTranslationsMarketingComposable } from '../composables/useGenericTranslationsMarketingComposable';
  ...
  const {
    ...
    sendFeedback,
  } = useGenericTranslationsMarketingComposable();
</script>
