<template>
  <div class="train-translations-marketing-component">
...
<script setup lang="ts">
  ...
  import { useTrainTranslationsMarketingComposable } from '../composables/useTrainTranslationsMarketingComposable';
  ...
  const {
    ...
    sendFeedback,
  } = useTrainTranslationsMarketingComposable();
</script>

<style scoped lang="scss">
  @import '@/scss/_variables.scss';
  .train-translations-marketing-component {
    overflow-x: hidden;
    max-width: 100%;
  }
