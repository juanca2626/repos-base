...
import type { ServiceDetailsRequest } from '@/modules/negotiations/products/configuration/content/package/serviceDetails/interfaces/service-details-request.interface';
