<template>
  ...
  >
    <a-form layout="vertical">
      ...
      <a-alert
        v-if="hasNoMoreTrainTypes"
        type="warning"
        show-icon
        message="No hay mas tipos de tren para seleccionar"
        class="mb-3"
      />
...
<script setup lang="ts">
  ...
  import { useTrainEditTypeDrawer } from '../composables/useTrainEditTypeDrawer';
  ...
  const {
    ...
    getLocationDisplayName,
  } = useTrainEditTypeDrawer(emit, props);
</script>
