...
export function useAccountingModuleSunatInformationComposable() {
  ...
  const handleClose = () => {
    ...
    const isSaved = getSavedFormComponent.value(
      FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION
    );

    if (isValid && isSaved) {
      handleIsEditFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
      return;
    }

    formState.value = { ...initialFormData.value };
    handleShowFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
  };
  ...
  const handleSaveForm = async () => {
    ...
    try {
      handleLoadingFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
      handleLoadingButtonSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
      ...
      handleIsEditFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
      handleSavedFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
    } catch (error: any) {
      handleError(error);
      console.log('⛔ Error save: ', error.message);
    } finally {
      handleLoadingFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
      handleLoadingButtonSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
    }
  };
  ...
  const handleShowForm = () => {
    handleIsEditFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
  };
  ...
  const fetchSunatInformation = async () => {
    ...
    if (data?.id) {
      ...
      handleIsEditFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
      handleSavedFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
      handleShowFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, true);
    } else {
      handleIsEditFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
      handleSavedFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
      handleShowFormSpecific(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION, false);
    }
  };
