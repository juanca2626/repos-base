<template>
  <div class="module-information-sunat">
    <div class="container">
...
<script setup lang="ts">
  ...
  import { useModuleSunatInformationComposable } from '@/modules/negotiations/supplier-new/composables/form/negotiations/module-configuration/module-sunat-information.composable';

  defineOptions({
    name: 'InformationSunatComponent',
  });
