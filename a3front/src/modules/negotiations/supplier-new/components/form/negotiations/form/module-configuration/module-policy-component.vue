...
<script setup lang="ts">
  ...
  import ModulePoliciesFormComponent from '@/modules/negotiations/supplier-new/components/form/negotiations/form/module-configuration/module-policies-form-component.vue';

  defineOptions({
    name: 'ModulePolicyComponent',
  });
