<template>
  <div class="module-accounting-information-sunat">
    <div class="container">
      <EmptyStateFormGlobalComponent
        v-if="!getShowFormComponent(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION)"
        title="Información Sunat"
        :formSpecific="FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION"
      />
      <div v-else>
        <div class="title-form">
          <div>Información Sunat</div>
          <div
            v-if="getIsEditFormComponent(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION)"
            class="edit-form"
        ...
        <spin-global-component
          tip="Cargando..."
          :spinning="getLoadingFormComponent(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION)"
        >
          <div
            v-if="!getIsEditFormComponent(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION)"
          >
            ...
            <div class="options-button">
              ...
              <a-button
                ...
                :loading="
                  getLoadingButtonComponent(FormComponentEnum.MODULE_ACCOUNTING_SUNAT_INFORMATION)
                "
                @click="handleSave"
              >
                Guardar datos
...
<script setup lang="ts">
  ...
  import { useAccountingModuleSunatInformationComposable } from '@/modules/negotiations/supplier-new/composables/form/accounting/module-configuration/accounting-module-sunat-information.composable';

  defineOptions({
    name: 'ModuleAccountingInformationSunatComponent',
  });
  ...
  const {
    ...
    handleSave,
    handleShowForm,
  } = useAccountingModuleSunatInformationComposable();
</script>

<style lang="scss">
  .module-accounting-information-sunat {
