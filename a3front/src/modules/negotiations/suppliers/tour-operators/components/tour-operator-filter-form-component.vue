...
<script setup lang="ts">
  ...
  import { useTourOperatorFilterForm } from '@/modules/negotiations/suppliers/tour-operators/composables/tour-operator-filter-form.composable';
  import FilterableCheckboxListComponent from '@/modules/negotiations/suppliers/tour-operators/components/filterable-checkbox-list-component.vue';
  ...
  const {
    ...
    handleCleanFilters,
    handleApplyFilters,
  } = useTourOperatorFilterForm(emit);
</script>
