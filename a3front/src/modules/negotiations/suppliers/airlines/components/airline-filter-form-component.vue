...
<script setup lang="ts">
  ...
  import { useAirlineFilterForm } from '@/modules/negotiations/suppliers/airlines/composables/airline-filter-form.composable';
  import FilterableCheckboxListComponent from '@/modules/negotiations/suppliers/airlines/components/filterable-checkbox-list-component.vue';
