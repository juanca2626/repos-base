      ...
      <a-spin :spinning="isLoading">
        <div class="main-container mt-2">
          ...
          >
            ...
            <!-- panel type foods -->
            <a-collapse-panel key="type-foods" class="custom-collapse-panel">
              <template #header>
                <span class="title-section"> Tipos de comidas </span>
              </template>

              <filterable-checkbox-list-component
                :options="typeFoods"
                v-model:selectedOptions="filterState.typeFoods"
                v-model:search="filterState.searchTypeFood"
                @loading="isLoading = $event"
              />
            </a-collapse-panel>

            <!-- panel amenities -->
            <a-collapse-panel key="amenities" class="custom-collapse-panel">
              <template #header>
                <span class="title-section"> Amenidades </span>
              </template>

              <filterable-checkbox-list-component
                :options="amenities"
                v-model:selectedOptions="filterState.amenities"
                v-model:search="filterState.searchAmenity"
                @loading="isLoading = $event"
              />
            </a-collapse-panel>
          </a-collapse>
...
<script setup lang="ts">
  ...
  import { useRestaurantFilterForm } from '@/modules/negotiations/suppliers/restaurants/composables/restaurant-filter-form.composable';
  import FilterableCheckboxListComponent from '@/modules/negotiations/suppliers/restaurants/components/filterable-checkbox-list-component.vue';
