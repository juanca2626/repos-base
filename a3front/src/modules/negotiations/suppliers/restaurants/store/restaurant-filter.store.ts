...
import type { FilterState } from '@/modules/negotiations/suppliers/restaurants/interfaces';

export const useRestaurantFilterStore = defineStore('restaurantFilterStore', () => {
