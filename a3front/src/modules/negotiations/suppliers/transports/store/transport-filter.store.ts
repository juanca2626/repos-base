...
import type { FilterState } from '@/modules/negotiations/suppliers/transports/interfaces';

export const useTransportFilterStore = defineStore('transportFilterStore', () => {
