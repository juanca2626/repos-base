...
import type { FilterState } from '@/modules/negotiations/suppliers/water-transports/interfaces';

export const useWaterTransportFilterStore = defineStore('waterTransportFilterStore', () => {
