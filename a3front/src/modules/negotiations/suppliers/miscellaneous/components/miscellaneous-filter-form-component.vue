...
<script setup lang="ts">
  ...
  import { useMiscellaneousFilterForm } from '@/modules/negotiations/suppliers/miscellaneous/composables/miscellaneous-filter-form.composable';
  import FilterableCheckboxListComponent from '@/modules/negotiations/suppliers/miscellaneous/components/filterable-checkbox-list-component.vue';
  ...
  const {
    ...
    handleCleanFilters,
    handleApplyFilters,
  } = useMiscellaneousFilterForm(emit);
</script>
