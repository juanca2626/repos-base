...
<script setup lang="ts">
  ...
  import { useCruiseFilterForm } from '@/modules/negotiations/suppliers/cruises/composables/cruise-filter-form.composable';
  import FilterableCheckboxListComponent from '@/modules/negotiations/suppliers/cruises/components/filterable-checkbox-list-component.vue';

  defineOptions({
    name: 'CruiseFilterFormComponent',
  });
