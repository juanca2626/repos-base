...
<script setup lang="ts">
  ...
  import { useLocalOperatorFilterForm } from '@/modules/negotiations/suppliers/local-operators/composables/local-operator-filter-form.composable';
  import FilterableCheckboxListComponent from '@/modules/negotiations/suppliers/local-operators/components/filterable-checkbox-list-component.vue';

  defineOptions({
    name: 'LocalOperatorFilterFormComponent',
  });
  ...
  const {
    ...
    handleCleanFilters,
    handleApplyFilters,
  } = useLocalOperatorFilterForm(emit);
</script>
