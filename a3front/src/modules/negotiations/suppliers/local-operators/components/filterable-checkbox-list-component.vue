...
<script setup lang="ts">
  ...
  import { useFilterableCheckboxList } from '@/modules/negotiations/suppliers/local-operators/composables/filterable-checkbox-list.composable';
  import type {
  ...
  defineOptions({
    name: 'FilterableCheckboxListComponent',
  });
