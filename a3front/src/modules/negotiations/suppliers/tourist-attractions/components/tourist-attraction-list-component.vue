...
<script setup lang="ts">
  ...
  import { useTouristAttractionList } from '@/modules/negotiations/suppliers/tourist-attractions/composables/tourist-attraction-list.composable';
