    ...
    <a-row :gutter="16">
      <a-col :span="5">
        <a-space direction="vertical" style="width: 100%">
          <a-form-item label="Clasificación de servicio" name="service_classification_id">
            <a-select
              style="width: 100%"
      ...
      <a-col :span="4">
        <a-space direction="vertical" :size="12">
          <a-form-item label="Cuenta costo" name="cost_account">
            <a-input
      ...
      <a-col :span="4">
        <a-space direction="vertical" :size="12">
          <a-form-item label="Cuenta venta" name="sale_account">
            <a-input
...
<script setup lang="ts">
  import { reactive, watch, defineEmits, ref, inject, onMounted } from 'vue';
  ...
  const date = ref('');
  const serviceClassificationList = ref<{ id: number; name: string }[]>([]);
