<template>
  <a-drawer
    ...
    :footer="null"
    placement="right"
    class="deactivate-holiday-drawer"
    @close="handleClose"
  >
    <!-- Header -->
    <template #title>
      <div class="drawer-header">
        <div class="drawer-title">
          <font-awesome-icon :icon="['fas', 'calendar-xmark']" class="title-icon" />
          <span>Desactivar fecha festiva</span>
        </div>
    ...
    <div class="drawer-content">
      ...
      <div class="reason-section">
        <label class="field-label">Motivo de desactivación</label>
        <a-textarea
...
<script lang="ts" setup>
  ...
  const historyItems = computed(() => {
        ...
        return [
          {
            ...
            reason: 'Festivo creado inicialmente',
          },
        ];
      }
      return [];
    ...
    return props.logs.map((log) => {
      ...
      if (actionUpper.includes('DEACTIVATE') || actionUpper.includes('DEACTIVATED'))
        label = 'Desactivada el';
      else if (actionUpper.includes('ACTIVATE') || actionUpper.includes('ACTIVATED'))
        label = 'Activada el';
      else if (actionUpper.includes('CREATE') || actionUpper.includes('CREATED'))
        label = 'Creada el';
      ...
      return {
        ...
        reason:
          actionUpper.includes('CREATE') || actionUpper.includes('CREATED')
            ? null
