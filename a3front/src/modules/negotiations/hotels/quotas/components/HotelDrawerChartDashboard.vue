<template>
  <a-drawer
    ...
    :keyboard="false"
    @close="handleClose"
    class="custom-filter-form-drawer hotel-drawer-chart-dashboard"
  >
    <template #title>
      <div class="drawer-header">
        <div class="header-content">
          ...
          <div class="sub-title-container">
            <div :class="`section-icon ${drawerIcon}-icon`"></div>
    ...
    <div class="drawer-body">
      <!-- Hyperguest Section -->
      <div v-if="chartDetails?.length > 0" class="section-container">
        <div class="section-header">
          <div class="section-title-wrapper">
            <div class="section-title">{{ chartDetails?.length }} hoteles conectados</div>
          </div>
          <div class="percentage-badge">{{ chartPercentage }}%</div>
        </div>
        <div class="body-content">
          <div class="body-content-item" v-for="item in chartDetails" :key="item.hotel_id">
...
<style lang="scss">
  [class*='css-dev-only-do-not-override'].ant-drawer.hotel-drawer-chart-dashboard
    .ant-drawer-header-title,
  [class*='css-dev-only-do-not-override'].ant-drawer
    .hotel-drawer-chart-dashboard
    .ant-drawer-header-title,
  .hotel-drawer-chart-dashboard.ant-drawer .ant-drawer-header-title,
  .hotel-drawer-chart-dashboard .ant-drawer .ant-drawer-header-title {
    align-items: flex-start !important;
  }
</style>
