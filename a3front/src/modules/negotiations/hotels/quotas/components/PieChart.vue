    ...
    <div class="chart-content">
        ...
        <div class="chart-wrapper" :style="sizeStyle">
          ...
          <div v-else class="chart-container">
            ...
            <div v-if="total" class="center-label-overlay">
              ...
              <div class="center-text">Total hoteles<br />cargados</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="stats-section">
        <div
          ...
          class="stat-item"
          @click="
            handleChartShowDrawerForm('Total de Hoteles', item.label, item.percentage, item.details)
          "
          ...
          series: [
            {
              ...
              padAngle: 5, // Espacio entre segmentos
              itemStyle: {
                borderRadius: 5,
                borderColor: '#fff',
                borderWidth: 0,
