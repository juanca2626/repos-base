  ...
  <a-form layout="vertical" class="my-3">
    <a-row justify="space-between" class="py-0 px-5" style="display: flex; flex-wrap: nowrap">
      <div style="flex: 1; margin-right: 10px">
        <a-form-item label="Servicio monitoreado:">
          <a-select v-model:value="formSearch.monitored">
            <a-select-option value="all">Todos</a-select-option>
            <a-select-option value="s">Monitoreados</a-select-option>
            <a-select-option value="n">No monitoreados</a-select-option>
          </a-select>
        </a-form-item>
      </div>
      ...
      <div style="flex: 1; margin-right: 10px">
        <a-form-item label="Servicio monitoreado:">
          <a-select v-model:value="formSearch.city">
