<template>
  ...
  >
      ...
      <a-row :gutter="16">
        ...
        >
          <template v-if="isOneSelect(option)">
            ...
            <template v-if="option.element === 'checkbox'">
              <a-checkbox
    ...
    <template #footer>
      <a-row>
        <a-col :span="24">
          <a-button type="primary" block @click="handleSubmit" :loading="loading">Guardar</a-button>
        </a-col>
      </a-row>
    </template>
  </a-drawer>
...
<script lang="ts" setup>
  ...
  // const resetForm = () => {
  //   formState.headquarter.code = '';
  //   formState.guideline.code = '';
  //   formState.observations = '';
  //   state.value = {};
  // };
